...
| [Interactive MCP App Panes](./interactive-mcp-app-panes.md) | Planned | Turn the four current MCP App panes into read-only interactive app surfaces with bridge-backed tool calls and structured fallback behavior. |
