...
/**
 * Create a mock Account with the given properties
 */
...
export const mockCheckingAccount = createMockAccount({
  id: 'checking-1',
...
/** Mock checking account snapshot with $1,000 balance */
export const mockCheckingSnapshot = createMockSnapshotWithConversion({
  accountId: 'checking-1',
  currentBalanceAmount: 100000, // $1,000
});

/** Mock savings account (asset) with $5,000 balance */
export const mockSavingsAccount = createMockAccount({
  id: 'savings-1',
...
/** Mock savings account snapshot with $5,000 balance */
export const mockSavingsSnapshot = createMockSnapshotWithConversion({
  accountId: 'savings-1',
  currentBalanceAmount: 500000, // $5,000
});

/** Mock credit card account (liability) with $500 balance */
export const mockCreditCardAccount = createMockAccount({
  id: 'credit-1',
  name: 'Credit Card',
...
/** Mock credit card snapshot with $500 balance */
export const mockCreditCardSnapshot = createMockSnapshotWithConversion({
  accountId: 'credit-1',
  currentBalanceAmount: 50000, // $500
});

/** Mock investment account (asset) with $10,000 balance */
export const mockInvestmentAccount = createMockAccount({
  id: 'investment-1',
