...
export const accountControllerUpdateBalance = (
  id: string,
  updateManualBalanceDto: UpdateManualBalanceDto,
  signal?: AbortSignal,
) => {
  return axios<Account>({
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: UpdateManualBalanceDto },
    TContext
  >
}): UseMutationOptions<
  Awaited<ReturnType<typeof accountControllerUpdateBalance>>,
...
export type AccountControllerUpdateBalanceMutationResult = NonNullable<
  Awaited<ReturnType<typeof accountControllerUpdateBalance>>
>
export type AccountControllerUpdateBalanceMutationBody = UpdateManualBalanceDto
