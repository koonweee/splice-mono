...
import type {
  ...
  NotificationControllerGetInboxParams,
...
export const notificationControllerGetEnrollmentEligibility = (
  enrollmentId: string,
  signal?: AbortSignal,
) => {
  return axios<PushEnrollmentEligibility>({
    url: `/notification/push/enrollment/${enrollmentId}`,
    method: 'GET',
    signal,
  })
}

export const getNotificationControllerGetEnrollmentEligibilityQueryKey = (
  enrollmentId?: string,
) => {
  return [`/notification/push/enrollment/${enrollmentId}`] as const
}

export const getNotificationControllerGetEnrollmentEligibilityQueryOptions = <
  TData = Awaited<
    ReturnType<typeof notificationControllerGetEnrollmentEligibility>
  >,
  TError = unknown,
>(
  enrollmentId: string,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getNotificationControllerGetEnrollmentEligibilityQueryKey(enrollmentId)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof notificationControllerGetEnrollmentEligibility>>
  > = ({ signal }) =>
    notificationControllerGetEnrollmentEligibility(enrollmentId, signal)
...
export type NotificationControllerGetEnrollmentEligibilityQueryResult =
  NonNullable<
    Awaited<ReturnType<typeof notificationControllerGetEnrollmentEligibility>>
  >
export type NotificationControllerGetEnrollmentEligibilityQueryError = unknown

export function useNotificationControllerGetEnrollmentEligibility<
  TData = Awaited<
    ReturnType<typeof notificationControllerGetEnrollmentEligibility>
  >,
  TError = unknown,
...
>(
  ...
  const queryOptions =
    getNotificationControllerGetEnrollmentEligibilityQueryOptions(
      enrollmentId,
      options,
    )
...
export const notificationControllerGetSummary = (signal?: AbortSignal) => {
  return axios<NotificationSummary>({
...
export const getNotificationControllerGetSummaryQueryKey = () => {
  return [`/notification/summary`] as const
}

export const getNotificationControllerGetSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof notificationControllerGetSummary>>,
  TError = unknown,
>(options?: {
  query?: Partial<
    UseQueryOptions<
      Awaited<ReturnType<typeof notificationControllerGetSummary>>,
      TError,
      TData
    >
  >
  ...
  const queryKey =
    queryOptions?.queryKey ?? getNotificationControllerGetSummaryQueryKey()

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof notificationControllerGetSummary>>
  > = ({ signal }) => notificationControllerGetSummary(signal)
...
export type NotificationControllerGetSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof notificationControllerGetSummary>>
>
export type NotificationControllerGetSummaryQueryError = unknown

export function useNotificationControllerGetSummary<
  TData = Awaited<ReturnType<typeof notificationControllerGetSummary>>,
  TError = unknown,
>(
  options: {
...
>(
  ...
  const queryOptions = getNotificationControllerGetSummaryQueryOptions(options)
...
export const notificationControllerGetInbox = (
  params?: NotificationControllerGetInboxParams,
  signal?: AbortSignal,
) => {
  return axios<NotificationInboxPage>({
...
export const getNotificationControllerGetInboxQueryKey = (
  params?: NotificationControllerGetInboxParams,
) => {
  return [`/notification/inbox`, ...(params ? [params] : [])] as const
}

export const getNotificationControllerGetInboxQueryOptions = <
  TData = Awaited<ReturnType<typeof notificationControllerGetInbox>>,
  TError = unknown,
>(
  params?: NotificationControllerGetInboxParams,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof notificationControllerGetInbox>>,
        TError,
        TData
      >
    >
  ...
  const queryKey =
    queryOptions?.queryKey ?? getNotificationControllerGetInboxQueryKey(params)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof notificationControllerGetInbox>>
  > = ({ signal }) => notificationControllerGetInbox(params, signal)
...
export type NotificationControllerGetInboxQueryResult = NonNullable<
  Awaited<ReturnType<typeof notificationControllerGetInbox>>
>
export type NotificationControllerGetInboxQueryError = unknown

export function useNotificationControllerGetInbox<
  TData = Awaited<ReturnType<typeof notificationControllerGetInbox>>,
  TError = unknown,
>(
  params: undefined | NotificationControllerGetInboxParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof notificationControllerGetInbox>>,
...
>(
  ...
  const queryOptions = getNotificationControllerGetInboxQueryOptions(
    params,
    options,
  )
...
export const notificationControllerMarkRead = (id: string) => {
  return axios<void>({ url: `/notification/${id}/read`, method: 'PATCH' })
}

export const getNotificationControllerMarkReadMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ['notificationControllerMarkRead']
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      'mutationKey' in options.mutation &&
      options.mutation.mutationKey
...
export type NotificationControllerMarkReadMutationResult = NonNullable<
  Awaited<ReturnType<typeof notificationControllerMarkRead>>
>

export type NotificationControllerMarkReadMutationError = unknown

export const useNotificationControllerMarkRead = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getNotificationControllerMarkReadMutationOptions(options)
...
export const getNotificationControllerArchiveMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof notificationControllerArchive>>,
    TError,
    { id: string },
    TContext
  >
  ...
  TContext
> => {
  const mutationKey = ['notificationControllerArchive']
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      'mutationKey' in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return notificationControllerArchive(id)
  }

  return { mutationFn, ...mutationOptions }
}

export type NotificationControllerArchiveMutationResult = NonNullable<
  Awaited<ReturnType<typeof notificationControllerArchive>>
>

export type NotificationControllerArchiveMutationError = unknown

export const useNotificationControllerArchive = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getNotificationControllerArchiveMutationOptions(options)
